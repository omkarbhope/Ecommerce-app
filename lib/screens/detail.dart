...
class _FoodDetailState extends State<FoodDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(foodNotifier.currentFood.name.toUpperCase(),style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
          ...
          child: Container(
            child: Column(
              ...
              children: <Widget>[
                ...
                //       onPressed: (){
                //         cartFood.add(foodNotifier.currentFood);
                //       }
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
            new  IconButton(
              icon: new Icon(Icons.remove,size: 40),
              onPressed: (){
                cartFood.remove(foodNotifier.currentFood);
                setState(()=>_itemCount--);
              },
              color: Colors.red),
